...
whichQuestion = 4                                                      # 1: run Q1; 2: run Q2; 3: run Bonus
...
def main():
    ...
    pygame.display.set_caption('CPSC 360 - Kevin Huang')                    # set title of the program window
    ...
    while True:
        ...
        #TODO: Q3 BONUS: Circle
        elif whichQuestion == 3:
            gluLookAt(50*math.sin(currAngle), 20, 50*math.cos(currAngle), 
                        0, 0, 0, 
                        0, 1, 0)
                
        #TODO: Q4 BONUS: Helix
        elif whichQuestion == 4:
            gluLookAt(50*math.sin(currAngle), 20*math.sin(2*currAngle), 50*math.cos(currAngle), 
                        0, 0, 0, 
                        0, 1, 0)
